...
- Авто-деактивация лотов, если товары закончились.
- Вечный онлайн.
...
- Возможность полностью настраивать авто-выдачу / авто-ответчик и все остальные модули FPC.
- Возможность добавлять авто-выдачу для лотов, получая лоты пряма с FunPay.
